...
static const u32 sNewGameBirch_Gfx[] = INCGFX_U32("graphics/rowan_speech/rowan.png", ".4bpp");
static const u32 sUnusedBirchBeauty[] = INCGFX_U32("graphics/birch_speech/unused_beauty.png", ".4bpp", "-num_tiles 822 -Wnum_tiles");
static const u16 sNewGameBirch_Pal[16] = INCGFX_U16("graphics/rowan_speech/rowan.png", ".gbapal");
